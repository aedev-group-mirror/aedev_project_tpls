...
configure on the ReadTheDocs server (`https://readthedocs.org/dashboard/aedev_project_templates/advanced`__)
...
if html_theme == 'alabaster':
    ...
    html_theme_options = dict(
        ...
        # gitlab_url=f"https://gitlab.com/aedev_project_templates-group/aedev_project_templates/docs/index.rst",
        navigation_depth=-1,
